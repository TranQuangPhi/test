...
const ThemeProvider: ThemeProviderComponent<AnyIfEmpty<ITheme>> =
  ThemeProviderStyled;
...
export const BaseProvider = ({
  ...
  const [colorModeValue, setColorModeValue] = useState(
  ...
  const darkTheme = useMemo(
    () => ({...theme, colors: {...theme.colors, ...theme.darkColors}}),
    [theme],
  );

  const newTheme = useMemo(
    () => (isLight ? theme : darkTheme),
